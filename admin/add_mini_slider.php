...
$image = time().$_FILES['image']['name'];
    ...
    if($_FILES['image']['type']=="image/png" || $_FILES['image']['type']=="image/jpeg" || $_FILES['image']['type']=="image/jpg")
    {
        ...
        $sql = "INSERT INTO mini_slider(image) VALUES ('$image')";
...
<form method="post" action="add_mini_slider.php"enctype="multipart/form-data" style="text-align:-webkit-center;  background-color:#3d7e7e; padding:21px;">
