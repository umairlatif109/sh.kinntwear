...
<body style="width:1000px;  margin:95px 243px;  text-align:-webkit-center;">
                    ...
                    <?php
                        ...
                        $sql  = "SELECT * FROM gallery WHERE user_id='$select_id'";
...
<h2>Update Service... </h2>
    <form method="post" action="update_gallery.php?edit_form=<?php echo $user_id; ?>" enctype="multipart/form-data">
...
$image = $_FILES['image']['name'];
 ...
 $sql = "UPDATE gallery SET image='$image'  WHERE user_id='$update_id'";
 }
 else{
  $sql = "UPDATE gallery SET heading='$heading', werbpage='$werbpage' WHERE user_id='$update_id'";
 }
  ...
  if ($conn->query($sql) === TRUE) {
   ...
   echo "<script>window.open('mange_gallery.php?updated=Post Updated', '_self')</script>";
